...
class ExecuteSQLTool:
    ...
    name = "execute_sql"
    description = "Execute a SQL SELECT query on the database. Use this for read-only queries."
    ...
    async def execute(
        ...
        from lira.db.models import Account, Transaction, Holding
...
class FetchStockTool:
    """Tool to fetch stock quotes from Yahoo Finance."""

    name = "fetch_stock"
    description = "Fetch current stock quote and basic info from Yahoo Finance."
...
class GetTransactionsTool:
    """Tool to get transactions with natural language filters."""

    name = "get_transactions"
    description = "Get transactions from the database with optional filters."
    ...
    async def execute(
        ...
        from lira.db.session import DatabaseSession
        from lira.db.models import Transaction, Category, Account
...
class GetPortfolioTool:
    """Tool to get investment portfolio holdings."""
    ...
    async def execute(
        ...
        """
        from lira.db.session import DatabaseSession
        from lira.db.models import Portfolio, Holding
...
class CalculateTaxTool:
    """Tool to calculate capital gains tax."""

    name = "calculate_tax"
    description = "Calculate estimated capital gains tax for realized gains."
